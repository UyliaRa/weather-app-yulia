...
export default function MainIcon(props) {
  if (props.code === "01d") {
    return <img className="mainicon" src={sun} alt="sunny" />;
  } else if (props.code === "01n") {
    return <img className="mainicon" src={sun} alt="sunny" />;
  } else if (props.code === "02d") {
    return <img className="mainicon" src={cloudy} alt="Few Clouds" />;
  } else if (props.code === "02n") {
    return <img className="mainicon" src={cloudy} alt="Few Clouds" />;
  } else if (props.code === "03d") {
    return <img className="mainicon" src={cloud} alt="Clouds" />;
    ...
    return <img className="mainicon" src={rainy} alt="Shower Rain" />;
  } else if (props.code === "09n") {
    return <img className="mainicon" src={rainy} alt="Shower Rain" />;
  } else if (props.code === "10d") {
    return <img className="mainicon" src={rain} alt="Rain" />;
  } else if (props.code === "10n") {
    return <img className="mainicon" src={rain} alt="Rain" />;
  } else if (props.code === "11d") {
    return <img className="mainicon" src={lightening} alt="Thunderstorm" />;
  } else if (props.code === "11n") {
    return <img className="mainicon" src={lightening} alt="Thunderstorm" />;
  } else if (props.code === "13d") {
    return <img className="mainicon" src={snow} alt="Snow" />;
  } else if (props.code === "13n") {
    return <img className="mainicon" src={snow} alt="Snow" />;
  } else if (props.code === "50d") {
    return <img className="mainicon" src={wind} alt="Mist" />;
  } else if (props.code === "50n") {
    return <img className="mainicon" src={wind} alt="Mist" />;
  } else {
    return <img className="mainicon" src={weather} alt="Weather" />;
  }
}
